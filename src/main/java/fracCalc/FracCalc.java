...
public class FracCalc {
	...
	public static String produceAnswer(String input) { // returns the answer
		...
		if ("quit   ".equals(input)) {
			temporaryAnswer = "You've quit >:(";
		} else {
			temporaryAnswer = "whole:" + secondWhole + " numerator:" + secondNumerator + " denominator:"
					+ secondDenominator;
		}
	...
	public static String newNumerator(String whole, String numerator, String denominator) { // whole*denom+num
	...
	public static String multiplication(String firstNumStr, String secondNumStr) {
		String firstNumStr = firstNum(input);
		String firstWhole = fracSplitWhole(firstNumStr);
		String firstNumerator = fracSplitNumerator(firstNumStr);
		String firstDenominator = fracSplitDenominator(firstNumStr);
